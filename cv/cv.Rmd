...
Henry Hansen, Karlstad University (co-supervisor)\hfill start: 2023\


**MSc students**

Julia Cao Sanchez, Uppsala University\hfill start: 2023\
Main supervisor for project: *Joint species distribution modelling of benthic\
invertebrate communities*

Leo Sheils, Uppsala University\hfill start: 2023\
...
*ggaqua*\hfill 2022\
<https://github.com/maxlindmark/ggaqua>
An R-package with a simple theme for ggplot2, theme_aqua(), that is based on SLU Aqua report style\
...
**Journals**: ICES Journal of Marine Science (6)\textperiodcentered Oikos (2)\textperiodcentered Nature Communications (2)\textperiodcentered Ecology (1)\textperiodcentered\
Scientific Reports (1)\textperiodcentered Functional Ecology (1)\textperiodcentered PLOS ONE (1)\textperiodcentered Proceedings of the Royal Society B (1) Fisheries (1) Canadian Journal of Fishery and Aquatic Sciences (1)
